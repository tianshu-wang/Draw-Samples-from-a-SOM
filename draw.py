...
distribution = [[]] # Put all data points (their indexs) into each cells, so that they can be selected later. 
...
# Draw samples from each cell, according to the number that the cell is called in chosen_bins
chosen = []
